...
mod_statusbar.create{
    ...
    -- windows and icons.
    --
    template="[ %date || load: %load ] [BATT: %laptopstatus_batterypercent %laptopstatus_batterytimeleft %laptopstatus_batterydrain ] TEMP: %laptopstatus_temperature] %filler%systray"
