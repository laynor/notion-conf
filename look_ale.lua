...
de.defstyle("frame", {
    ...
    shadow_pixels = 1,
    de.substyle("active", {
        shadow_colour = "#aa00aa",   -- frame border here
        highlight_colour = "#aa00aa",
...
de.defstyle("tab", {
    ...
    de.substyle("active-selected", {
        ...
        background_colour = "#31008a",
        foreground_colour = "#ffffff",
    }),
    de.substyle("active-unselected", {
        shadow_colour = "#dfb700",
        highlight_colour = "#ffe700",
        background_colour = "#1b004d",
